<%@ Page Title="" Language="C#" MasterPageFile="~/profile.Master" AutoEventWireup="true" CodeBehind="pharmacy.aspx.cs" Inherits="DoctorPage.pharmacy" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <div class="fclinic">
        ...
        <asp:Label ID="Label7" runat="server" Text="اسم الصيدلية"></asp:Label>
        <br />
