<%@ Page Title="" Language="C#" MasterPageFile="~/profile.Master" AutoEventWireup="true" CodeBehind="blood_bank.aspx.cs" Inherits="DoctorPage.blood_bank" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div class="fclinic">
        ...
        <asp:Label ID="Label7" runat="server" Text="اسم بنك الدم"></asp:Label>
        <br />
