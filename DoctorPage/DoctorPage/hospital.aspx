...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="fclinic">
        ...
        <asp:Label ID="Label7" runat="server" Text="اسم المستشفي"></asp:Label>
        <br />
        ...
        <asp:Label ID="Label" runat="server" Text="التخصص"></asp:Label>
        <br />
        ...
        &nbsp;<script>
                  ...
                  marker.on('dragend', function (event) {
                      ...
                      document.getElementById('lathospital').value = position.lat;
                      document.getElementById('lnghospital').value = position.lng;
