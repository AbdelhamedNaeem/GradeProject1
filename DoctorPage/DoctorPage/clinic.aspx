<%@ Page Title="" Language="C#" MasterPageFile="~/profile.Master" AutoEventWireup="true" CodeBehind="clinic.aspx.cs" Inherits="DoctorPage.clinic" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="fclinic">
        ...
        <asp:Label ID="Label7" runat="server" Text="اسم العيادة"></asp:Label>
        <br />
        ...
        <br />
        <asp:DropDownList ID="specli" runat="server" DataTextField="spec_name"
            DataValueField="spec_id">
        </asp:DropDownList>
        <asp:Label ID="Label10" runat="server" Text="التخصص"></asp:Label>
        <br />
