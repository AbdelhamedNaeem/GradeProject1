<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="BankSearch.aspx.cs" Inherits="GradeProject.BankSearch" %>
                ...
                <table style="border: thick outset #808000; class="auto-style1">
                    <tr>
                        <td class="auto-style2">name:
                                        <asp:Label ID="bb_nameLabel" runat="server" Text='<%# Eval("bb_name") %>' />
                            <br />
                                        address:
                                        <asp:Label ID="bb_addressLabel" runat="server" Text='<%# Eval("bb_address") %>' />
                            <br />
                                        phone:
                                        <asp:Label ID="bb_phoneLabel" runat="server" Text='<%# Eval("bb_phone") %>' />
                            <br />
                                        link:
                                        <asp:Label ID="bb_linkLabel" runat="server" Text='<%# Eval("bb_link") %>' />
                        </td>
                    </tr>
                </table>
            </ItemTemplate>
